...
class News_Block extends Component {
  render() {
    ...
    let handleSmallContent = this.props.block_small_content
    handleSmallContent = handleSmallContent.split('');
    handleSmallContent.length = 300
    return (
      <div className="col-lg-4 col-sm-6 mb-4">
        <div className="card h-100 News_Block">
          ...
          <div className="card-body News_Block_background">
            ...
            <p className="card-text">{handleSmallContent.join('') + '...'}</p>
