...
class NavigationBar extends Component {
  ...
  render() {
    ...
    const btnLogin = !isLogin ? 
      ...
      <>
        <li class="dropdown btn btn-outline-primary  ml-md-4" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          {email}
        </li>
